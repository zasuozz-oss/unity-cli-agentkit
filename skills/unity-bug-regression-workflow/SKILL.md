...
## When to Use
- Receiving any bug report, especially in `[version (build)] description [STR: step -> step -> result]` format.
...
**User**: "fix this bug, and check memory first because the last fix for it caused a different bug: [1.4.2 (57)] the error popup does not show when Facebook login fails"
